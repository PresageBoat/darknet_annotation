...
void replace_image_to_label(const char* input_path, char* output_path)
{
    ...
    find_replace(output_path, "/train/", "/labels/", output_path);    // kaiwang-20200522
    find_replace(output_path, "/val/", "/labels/", output_path);    // kaiwang-20200522
    find_replace(output_path, "/images/", "/labels/", output_path);    // kaiwang-20200822
